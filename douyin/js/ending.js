 ...
 * 计算结局 - 路径权重主导模式
 */
function calculateEnding(gameData) {
 ...
 * 获取结局描述文案
 */
function getEndingText(endingType, mbtiType, variant) {
  const variants = {
    [ENDING_TYPES.TRUTH_END]: {
